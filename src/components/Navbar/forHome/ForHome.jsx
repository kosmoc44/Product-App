...
const ForHome = () => {
    ...
    useEffect(() => {
        const fetchCards = async () => {
            try {
                const cosmeticsResponse = await fetch('https://dummyjson.com/products/category/home-decoration');
                const cosmeticsData = await cosmeticsResponse.json();

                const fragrancesResponse = await fetch('https://dummyjson.com/products/category/kitchen-accessories');
                const fragrancesData = await fragrancesResponse.json();

                const allProducts = [...cosmeticsData.products, ...fragrancesData.products];
